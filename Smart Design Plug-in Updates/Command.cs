    ...
    public class Command : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            try
            {
                ...
                {
                    #region Project ID
                    string projectID = ExporterIFCUtils.CreateProjectLevelGUID(doc, Autodesk.Revit.DB.IFC.IFCProjectLevelGUIDType.Project);
                    #endregion
                    ...
                    AddItemstoSmartSchedule x = new AddItemstoSmartSchedule(ElementsGroups, doc, projectID);
                    x.Height = 555;
                    x.Width = 1200;
            ...
            catch(Exception e)
            {
                ...
                MessageBox.Show("Nothing selected", "Error", buttons, MessageBoxImage.Error);
            }
